  ...
  return (
    <div className={`min-h-screen main-background theme-${theme} flex flex-col justify-center items-center`}>
        ...
        <div className='footer relative w-[100%] mt-[auto] flex items-center justify-between p-[10px]'>
            ...
            <button ref={cabinetRef} onClick={() => navigate('/cabinet')} className='cursor-pointer w-1/3 py-[10px] flex justify-center relative z-10'>
            ...
            <button ref={homeRef} onClick={() => navigate('/')} className='cursor-pointer w-1/3 py-[10px] flex justify-center relative z-10'>
            ...
            <button ref={tariffsRef} onClick={() => navigate('/tariffs')} className='cursor-pointer w-1/3 py-[10px] flex justify-center relative z-10'>
