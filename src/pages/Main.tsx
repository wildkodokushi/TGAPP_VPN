      ...
      <div className="">
        ...
        <div className="bg-[rgba(210,0,255,0.05)] border-2 border-white/10 rounded-2xl w-[354px] p-[20px_15px_25px] my-[20px]">
          ...
          <div className="flex flex-col items-center justify-between gap-2">
            ...
            <button onClick={handleBuyClick} className="cursor-pointer w-[100%] bg-[#d200ff] inline-flex items-center h-[47px] px-5 text-white font-bold bounded-font text-base leading-none rounded-3xl justify-center text-center transition-colors">
              Купить
            </button>
          </div>
          ...
          <div className="flex flex-col items-center gap-2 mt-[25px]">
            ...
            <div className="w-[100%] inline-flex items-center justify-between h-[47px] px-5 border border-white/20 rounded-3xl bg-black/30 bounded-font">
              <span className="font-normal text-[13px] leading-none text-white/70 whitespace-nowrap overflow-hidden text-ellipsis" ref={inviteTextRef} >
